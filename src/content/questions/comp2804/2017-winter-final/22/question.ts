...
const label1 = String.raw`$(1/4)^{m} \cdot 3/4$`;
const label2 = String.raw`$(1/4)^{m-1} \cdot 3/4$`;
const label3 = String.raw`$(3/4)^{m} \cdot 1/4$`;
const label4 = String.raw`$(3/4)^{m-1} \cdot 1/4$`;
